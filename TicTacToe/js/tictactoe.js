...
if (activePlayer === 'X') {
//If activePlayuer is equal to X, the x.png is placed in HTML
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //true is returned and our else if condition executed
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //This line accesses our HTML canmvas
    ...
    y2 = coordY2,
    //this variables stores seperate x axis data we update in our animation loop.
    x = x1,
